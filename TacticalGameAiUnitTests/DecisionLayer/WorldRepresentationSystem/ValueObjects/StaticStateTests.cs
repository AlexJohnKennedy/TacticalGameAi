...
namespace TacticalGameAiUnitTests.DecisionLayer.WorldRepresentationSystem.ValueObjects {
    ...
    class StaticStateTests {
        ...
        [Test]
        public void Constructor_PassedWellSizedArrays_DoesNotThrow() {
            StaticState.AreaEdge[,] e1 = new StaticState.AreaEdge[13, 13];
            StaticState.AreaNode[] n1 = new StaticState.AreaNode[13];

            Assert.DoesNotThrow(() => new StaticState(n1, e1));
        }
